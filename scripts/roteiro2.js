const roteiro2 = {
  ...
  problemas: [
    ...
    },
    {
      ...
      descricao_solucao: "Ao ler os digitos como string, verifique a existecia do caractere falho na string e remova-os ou crie outra string sem eles, após isso basta verificar a questão dos 0's.",
      analise: "Já que é preciso percorrer a string 2 vezes para analizar os requisitos, a complexidade seria O(N + N).",
    ...
    },
    {
      ...
      descricao_solucao: "Basta guardar em duas variáveis a quantidade depositada nos cofres dos dois netos e verificar a diferença. Quando houver um novo depósito ter o cuidado de somar o que já se encotra depositado com o novo.",
